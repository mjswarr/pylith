...
/** @file modulesrc/materials/IsotropicSelfGravElasticity.i
 *
 * Python interface to C++ IsotropicSelfGravElasticity.
 */

namespace pylith {
    namespace materials {
        class IsotropicSelfGravElasticity : public pylith::materials::RheologySelfGravElasticity {
            // PUBLIC METHODS /////////////////////////////////////////////////////
public:
