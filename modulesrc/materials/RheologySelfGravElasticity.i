...
/** @file modulesrc/materials/RheologySelfGravElasticity.i
 *
 * Python interface to C++ abstract base class RheologySelfGravElasticity.
 */

namespace pylith {
    namespace materials {
        class RheologySelfGravElasticity : public pylith::utils::PyreComponent {
            // PUBLIC METHODS //////////////////////////////////////////////////////////////////////////////////////////
public:
